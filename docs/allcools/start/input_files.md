...
For more details on generating and handling ALLC files, please read the introduction of [`allcools` command line tools](../command_line/allcools.ipynb).
...
For cellular analysis like clustering, we need to first aggregate the base-level methylation information into
