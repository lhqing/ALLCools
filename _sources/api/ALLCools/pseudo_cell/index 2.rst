:py:mod:`ALLCools.pseudo_cell`
==============================

.. py:module:: ALLCools.pseudo_cell
...
.. toctree::
   ...
   pseudo_cell_kmeans/index.rst
   pseudo_cell_knn/index.rst


Package Contents
----------------

.. py:function:: generate_pseudo_cells_kmeans(adata, cluster_col='leiden', obsm='X_pca', cluster_size_cutoff=100, max_pseudo_size=25, aggregate_func='downsample')
...
.. py:function:: generate_pseudo_cells_knn(adata, cluster_col='leiden', obsm='X_pca', target_pseudo_size=100, min_pseudo_size=None, ignore_small_cluster=False, n_components=None, aggregate_func='downsample', pseudo_ovlp=0)
