...
def get_default_motif_set(database='three_databases'):
    if database == 'three_databases':
        motif_set = parse_meme_database(f'{DEFAULT_MOTIF_DIR}/JASPAR2018HOCOMOCOv11Jolma2013.meme',
                                        f'{DEFAULT_MOTIF_DIR}/JASPAR2018HOCOMOCOv11Jolma2013.metadata.csv')

        # default thresholds, fnr/fpr = 1000
        motif_set.thresholds = pd.read_csv(f'{DEFAULT_MOTIF_DIR}/JASPAR2018HOCOMOCOv11Jolma2013.thresholds.csv',
                                           header=None,
                                           index_col=0,
