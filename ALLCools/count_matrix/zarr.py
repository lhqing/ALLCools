...
def dataset_to_array(ds, use_cells=None, use_genes=None, sparse=True, obs_dim='cell', var_dim='gene', chunk=100000):
...
def dataset_to_adata(ds, use_cells=None, use_genes=None, sparse=True, obs_dim='cell', var_dim='gene', chunk=100000):
    data, use_cells, use_genes = dataset_to_array(ds,
                                                  use_cells=use_cells,
                                                  use_genes=use_genes,
                                                  sparse=sparse,
                                                  obs_dim=obs_dim,
